import { type AuthRole, type RuntimeM2MField, SubmitRelationHandler, SubmitValue } from '@oinone/kunlun-engine';
...
export class FormM2MRoleFieldWidget extends AbstractFormRoleFieldWidget<AuthRole, AuthRole[], RuntimeM2MField> {
  @Widget.Reactive()
