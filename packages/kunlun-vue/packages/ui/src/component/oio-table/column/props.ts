...
export const OioColumnEditorProps = {
  ...
  editorConfirm: {
    type: [String, Function] as PropType<string | ((context: RowContext) => string)>
  },
  editorConfirmPosition: {
    type: [String, Function] as PropType<PopconfirmPlacement | ((context: RowContext) => PopconfirmPlacement)>
  },
  editorCondition: {
    type: Function as PropType<(context: RowContext) => ReturnPromise<boolean | undefined>>
  },
  editorEnterText: {
    type: [String, Function] as PropType<string | ((context: RowContext) => string)>
  },
