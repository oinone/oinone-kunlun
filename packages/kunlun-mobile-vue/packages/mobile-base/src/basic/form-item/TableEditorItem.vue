...
import { OioFormItem, PropRecordHelper } from '@kunlun/vue-ui-mobile-vant';
...
export default defineComponent({
  ...
  render() {
    const classList = ['default-table-editor-item', 'form-field-widget', 'item', 'hide-form-item-label'];
