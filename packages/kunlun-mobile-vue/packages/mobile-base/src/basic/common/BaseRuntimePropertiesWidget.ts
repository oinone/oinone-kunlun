import type { ActiveRecord, RuntimeModel, RuntimeView, RuntimeViewAction } from '@oinone/kunlun-engine';
...
> extends ActiveRecordsWidget<Props> {
  ...
  public parentOpenerActiveRecords: ActiveRecord[] | undefined;
