...
import {
  type ClickResult,
  type PopupEventHandle,
  type PopupEventHandles,
  PopupScene,
  type PopupSubmitOptions,
  type PopupSubmitParameters,
  PopupSubmitType
} from '../../typing';
  ...
  implements IPopupWidget<Props>
{
  ...
  protected async onSubmitProvider(options?: PopupSubmitOptions) {
  ...
  protected async onCancelProvider() {
