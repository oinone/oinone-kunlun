import { ActiveRecord, FunctionCache, FunctionMetadata, RuntimeServerAction, SubmitValue } from '@kunlun/engine';
...
@SPI.ClassFactory(ActionWidget.Token({ name: ModelDefaultActionName.$$internal_BatchUpdate }))
