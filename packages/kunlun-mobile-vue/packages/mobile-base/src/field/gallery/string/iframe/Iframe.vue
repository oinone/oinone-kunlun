<template>
  <gallery-common-field
    :class="[value || defaultValue ? 'mobile-iframe-detail-common-field' : 'mobile-iframe-detail-common-field-empty']"
  ...
  >
    <template #default="{ realValue }">
      <div class="detail-iframe">
        <iframe :src="realValue" frameborder="0"></iframe>
      </div>
    </template>
  </gallery-common-field>
</template>
...
<style lang="scss">
.mobile-iframe-detail-common-field {
  display: block;
  width: 100%;
  height: 700px;
