import { CHECK_CHINESE, CHECK_CODE, CHECK_CONTAINS_CHINESE, CHECK_EMAIL, CHECK_ENG_NUM, CHECK_ID_CARD, CHECK_INTEGER, CHECK_IP, CHECK_NUMBER, CHECK_PHONE, CHECK_PWD, CHECK_TWO_DIG, CHECK_URL } from './regexp';
