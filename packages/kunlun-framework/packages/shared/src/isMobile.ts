...
function isMobile(userAgent?) {
  ...
  const result = {
    ...
    android: {
      phone:
        (!match(windowsPhone, ua) && match(amazonPhone, ua)) || (!match(windowsPhone, ua) && match(androidPhone, ua)),
      tablet:
      ...
      device:
        (!match(windowsPhone, ua) &&
          (match(amazonPhone, ua) || match(amazonTablet, ua) || match(androidPhone, ua) || match(androidTablet, ua))) ||
